...
Most researchers believe that visual perceptions are encoded in an analog fashion, so that the memory of an image is closely related to the perception of that same image [@cognition].
...
@shepard1988mental showed that reaction time was proportional to the angle of rotation of the stimuli, which suggests that participants were mentally rotating the figure as they would rotate a three-dimensional figure in space. 

![Rotation task from @shepard1988mental. Are the two images the same? [[Image Source](https://en.wikipedia.org/wiki/Mental_rotation#/media/File:Mental_rotation_task_(diagram)_(cropped).jpg) [License](https://commons.wikimedia.org/wiki/File:Mental_rotation_task_(diagram)_(cropped).jpg?uselang=en#Licensing)]{.fig-citation}](../fig/Mental_rotation_task_(diagram)_(cropped).jpg){#fig-mentalRotation}

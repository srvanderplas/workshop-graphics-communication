...
You want to provide information on the average direction of high wind speeds (gusts $\geq 50$ mph) in a location over the course of a year, to assist with placement of two sets of emergency equipment to minimize the probability that a single high-wind event compromises both locations.
...
Consider the following two versions of the same chart:

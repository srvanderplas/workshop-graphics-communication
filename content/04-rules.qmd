...
```{r cartesian-wind-plot}
#| fig-width: 6
#| fig-height: 6
#| fig-label: fig-cartesian-wind
#| fig-cap: Plot of high wind gust directions and speed for Brownville, NE between 2000 and 2009, using Cartesian coordinates.
#| echo: false
```
...
#| fig-width: 6
#| fig-height: 6
#| fig-label: fig-polar-wind
#| fig-cap: Plot of high wind gust directions and speed for Brownville, NE between 2000 and 2009, using polar coordinates.
#| echo: false
```

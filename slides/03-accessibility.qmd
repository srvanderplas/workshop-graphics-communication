...
- [ggplot2](../demo/penguins-ggplot2.html)
- [Observable.js](../demo/penguins-obs.html)
- [Observable.js + OLLi](../demo/penguins-obs-olli.html)
...
library(ggplot2)
plot <- ggplot(data) + 
  stat_density_2d(aes(x = bill_depth_mm, y = bill_length_mm, 
...
library(rayshader) 
plot_gg(plot, emboss_text = .05, width = 8, height = 4)
rgl::rglwidget() 
```